...
export const FwProductDetail = () => {
  ...
  return (
    <div className='page-wrapper'>
      ...
      <div id='popup' className={`popup${isPopupOpen ? ' -active' : ''}`}>
        <div className='container'>
          {/* 팝업 헤더 영역 */}
          <FwHeader
            title='팝업 타이틀'
                        ...
                        panel: (
                          <>
                            <dl className='prodect-info-dl'>
                              ...
                              <dd>
                                <p className='p'>
                                  매월 약정 납입일에 저축금을 납입하여 순위 요건
                                  충족시 국민 주택과 민영주택권이 부여되는 입주자
                                  저축
                                </p>
                              </dd>
                              ...
                              <dd>
                                <p className='p'>
                                  국민인 개인(국내에 거주하는 재외동포 포함)또는
                                  외국인 거주자로서 연령에 관계없이 누구나 가입가능
                                </p>
                                <ul className='ul -bullet'>
                                  <li>
                                    주택청약종합저축의 가입은
                                    청년우대형주택청약종합저축, 청약저축, 청약예금,
                                    청약부금을 포함 하여 전 금융기관 1인1계좌에 한함
                                  </li>
                                  <li>
                                    비과세종합저축으로 가입가능(본인 한도 내)
                                  </li>
                                </ul>
                              </dd>
                              ...
                              <dd>
                                <p className='p'>
                                  매월 약정납입일(신규가입일 해당일)에 2만원 이상
                                  50만원 이하의 금액을 10원 단위로 자유롭게 납입
                                  <br />
                                  단, 월 납입금의 총액이 1,500만원에 이를 때까지는
                                  50만원을 초과하여 납입가능
                                </p>
                                <p className='p'>
                                  선납회차 : 정상 납입회차에 추가하여 최고
                                  24회차까지 선납가능
                                </p>
                              </dd>
                            </dl>
                            ...
                            <div className='procuct-iframe'>
                              <iframe className='iframe' title='product-guide-iframe'>
                                아이프레임
                              </iframe>
                            </div>
                          </>
                        ...
                        panel: (
                          <>
                            ...
                            <p className='p'>
                              ...
                              <br />
                              가족이 대리가입 시 가족관계 확인서류 및 대리인
                              실명확인증표
                              <br />
                              (미성년자 가입 시 법정 대리인 확인서류 포함)
                            </p>
                            ...
                            <ul className='ul -bullet'>
                              <li>
                                월 납입금이 10만원을 초과하는 경우 10만원만
                                인정됩니다.
                              </li>
                              <li>
                                국민주택 청약 1순위 요건은 입주자 모집공고일
                                기준으로 다음과 같으며, 따라서 입금 시 분할 입금
                                여부를 명확히 밝혀 주시기 바랍니다.
                                <div>
                                  <ul className='ul -dash'>
                                    <li>
                                      투기과열지구 또는 청약과열 지역 : 가입 후
                                      24개월이 경과하고 월납입금 24회 이상 납입한
                                      자
                                    </li>
                                    <li>
                                      수도권 : 가입 후 12개월이 경과해도 월납입금
                                      12회 이상 납입 한 자 (24개월 및 24회까지
                                      연장가능)
                                    </li>
                                    <li>
                                      수도권 외 : 가입 후 6개월이 경과하고 월납입금
                                      6회 이상 납입한 자 (12개월 및 12회까지
                                      연장가능)
                                    </li>
                                  </ul>
                                </div>
                              ...
                              <li>
                                월납입금을 연체 및 선납한 계좌는
                                『주택공급에 관한 규칙』에 따라 납입인정일 및 순위
                                발생일이 지연될 수 있으며, 청약순위는 해당 회차가
                                인정되는 일자(납입인정일)에 도달하여야 발생합니다.
                              </li>
                              <li>
                                투기과열지구 및 청약과열지역 1순위 청약 시 세대주가
                                아닌 자, 과거 5년 이내 다른 주택에 당첨된 세대에
                                속한 자, 재당첨 제한대상 세대에 속한 자, 유주택
                                세대에 속한 자는 자격이 제한 됩니다.
                              </li>
                            </ul>
                            <h5 className='h6'>민영주택 청약의 경우</h5>
                            <ul className='ul -bullet'>
                              <li>
                                민영주택 청약 1순위 요건은 입주자모집공고일
                                기준으로 다음과 같습니다.
                                <div>
                                  <ul className='ul -dash'>
                                    <li>
                                      투기과열지구 또는 청약과열지역 : 가입 후
                                      24개월이 경과하고 청약예치기준급액 충족한 자
                                    </li>
                                    <li>
                                      수도권 : 가입 후 12개월이 경과하고
                                      청약예치기준금액 충족한 자 (24개월까지
                                      연장가능)
                                    </li>
                                    <li>
                                      수도권 외 : 가입 후 6개월이 경과하고
                                      월납입금 6회 이상 납입한 자 (12개월까지 연장
                                      가능)
                                    </li>
                                    <li>
                                      위축지역 : 가입 후 1개월이 경과하고
...
export default FwProductDetail;
